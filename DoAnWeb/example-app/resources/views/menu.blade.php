    ...
    <div class="flex items-center justify-between h-16">
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          ...
          <a href="/" class="px-3 py-2 rounded-md text-sm font-medium text-white hover:text-gray-300">Home</a>
            ...
            <div class="relative">
              ...
              <div class="absolute right-0 mt-2 w-56 origin-top-right bg-white rounded-md shadow-lg hidden" id="aboutMenuDropdown">
                <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="aboutMenu">
                  ...
                  <a href="/Nguoinhannuoi" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Nguoi Nhan Nuoi</a>
                </div>
              </div>
            </div>
