...
<body>
    ...
    <h1 class="text-2xl font-bold mb-4 text-center text-blue-700 m-12">Nhập Liệu Tin Tức</h1>
            ...
            <tbody>
                ...
                <div class="flex items-center my-4">
                    ...
                    <div class="flex items-center ml-4">
                        <form action="{{ route('searchTinTuc') }}" method="POST">
                            @csrf
