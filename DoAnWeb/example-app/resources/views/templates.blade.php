...
<div>
    ...
    <h3>Kính gửi anh/chị: {{$name}}</h3>
    <p>Tôi viết thư này thay mặt cho <b>Dự Án Nuôi Em</b> để bày tỏ lòng biết ơn sâu sắc đối với sự hỗ trợ quý báu của bạn dành cho chương trình của chúng tôi.</p>
    <p>Sự hỗ trợ của bạn không chỉ mang lại lợi ích thiết thực cho em <b>{{$treem_name}}</b> mà còn truyền cảm hứng cho chúng tôi tiếp tục sứ mệnh của mình. Nhờ những tấm lòng nhân ái như bạn, chúng tôi có thể tạo ra những thay đổi tích cực cho cộng đồng.</p>   
    <p>Sau đây là thông tin về bé <b>{{$treem_name}}</b></p>
    <p>Mã Nhận Nuôi: <b>{{$treem_id}}</b></p>
